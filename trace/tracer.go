...
func (t Tracer) ExtensionName() string {
	return scout.ScopedKey("Tracer", nil)
}
...
func (t Tracer) InterceptField(ctx context.Context, next graphql.Resolver) (interface{}, error) {
	...
	span, ctx := scout.StartTrace(ctx, name)
	span.SetAttributes(
	...
	scout.RecordSpanError(
		span, err,
		attribute.String(scout.SourceAttribute, "InterceptField"),
	)
	scout.EndTrace(span)
...
func GraphQLRecoverFunc() graphql.RecoverFunc {
	return func(ctx context.Context, err interface{}) error {
		...
		scout.RecordError(ctx, e, attribute.String(scout.SourceAttribute, "GraphQLRecoverFunc"))
		return e
	}
}
